    ...
    <div className="min-h-full bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100 px-8 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2 text-sm text-gray-500">
          <Link href="/BISINDO/kamus" className="hover:text-teal-600 transition">
            Kamus
          </Link>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm">
              ...
              <ol className="list-decimal list-inside space-y-4 text-sm text-gray-600 marker:font-bold marker:text-teal-600 marker:text-base">
            ...
            <div className="bg-gray-100/80 rounded-3xl p-6 border border-gray-200 relative overflow-hidden">
              ...
              <Link href="/BISINDO/quiz" className="px-6 py-2.5 bg-gray-900 text-white font-semibold text-sm rounded-xl hover:bg-black shadow-md transition relative z-10">
                Mulai Kuis
              </Link>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {konten.related.map((slugTerkait) => {
              ...
              return (
                <Link 
                  key={slugTerkait}
                  href={`/BISINDO/kamus/${slugTerkait}`} 
                ...
                >
                  ...
                  <div className="p-4 flex items-center justify-between">
                    <div>
                      <h4 className="font-bold text-gray-900 text-sm mb-1.5 group-hover:text-teal-600 transition">
                        {itemTerkait.title}
                      </h4>
                    ...
                    <div className="w-8 h-8 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-teal-600 group-hover:text-teal-600 transition">
                      ▶
                    </div>
                  </div>
                </Link>
