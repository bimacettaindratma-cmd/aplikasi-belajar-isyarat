...
export default function VideoLengkapPage() {
  ...
  const timestamps = [
    { time: "00:00", label: "Pengenalan BISINDO" },
    ...
    <div className="min-h-full bg-gray-50 select-none">
      ...
      <div className="bg-white border-b border-gray-100 px-8 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2 text-sm text-gray-500">
          <button
            onClick={() => router.push("/BISINDO/alfabet")}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6">
          ...
          <div className="space-y-5">
            ...
            <div className="w-full aspect-video bg-slate-800 rounded-2xl overflow-hidden shadow-sm relative flex items-center justify-center border-4 border-white">
              <video
                src="/videos/bisindo-lengkap.mp4"
                controls
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <span className="bg-teal-50 text-teal-600 text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full">
                Video Panduan Utama
              </span>
              <h2 className="text-base font-extrabold text-gray-900 mt-3 mb-2">
                Kompilasi Isyarat BISINDO: Alfabet & Angka
              </h2>
              <p className="text-sm text-gray-500 leading-relaxed">
                Halaman ini menyajikan peragaan isyarat secara menyeluruh untuk mempermudah Anda melihat transisi gerakan antar huruf dan angka secara mengalir. Disarankan menggunakan kecepatan <span className="font-bold text-teal-600">0.5x</span> jika Anda baru pertama kali memulai latihan hafalan.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="space-y-2">
                {timestamps.map((item, index) => (
                  <button
                    key={index}
                    className="w-full flex items-center justify-between p-3 rounded-xl bg-gray-50 hover:bg-teal-50 border border-gray-100 text-left text-xs transition group"
                  >
                    <span className="font-bold text-gray-700 group-hover:text-teal-600">
                      {item.label}
                    </span>
                    <span className="font-mono bg-gray-200 group-hover:bg-teal-600 group-hover:text-white px-2 py-0.5 rounded-md text-gray-500 text-[11px] transition">
                      {item.time}
                    </span>
                  </button>
                ))}
            ...
            <div className="bg-teal-600 rounded-2xl p-5">
              ...
              <ul className="text-teal-100 text-xs space-y-2 leading-relaxed list-disc list-inside">
                <li>Gunakan tangan dominan Anda (kanan/kiri) secara konsisten sepanjang video.</li>
                <li>Ekspresi wajah (mimik) sangat memengaruhi penyampaian arti dalam BISINDO.</li>
