  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gray-50 select-none">
      <main className="px-8 py-8 space-y-6 max-w-7xl w-full mx-auto">
        ...
        {/* Promo banner */}
        <div className="animate-fade-up-delay-1 bg-linear-to-br from-teal-700 to-emerald-300 rounded-3xl px-9 py-10">
          <span className="inline-block bg-white/20 text-white text-[11px] font-bold tracking-wide px-3 py-1 rounded-full mb-4">
            TERBARU
          </span>
          <h3 className="text-white text-2xl font-bold mb-2">Learn BISINDO</h3>
        ...
        <div className="animate-fade-up-delay-2 grid lg:grid-cols-[1.4fr_1fr] gap-6 items-start">
            ...
            <div className="animate-fade-up-delay-2 bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">Bahasa Isyarat · BISINDO</p>
                </div>
                <Link  href="/BISINDO/kamus/terimakasih" className="flex items-center gap-1.5 text-teal-600 text-sm font-semibold hover:underline">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col items-center text-center">
              ...
              <div className="relative w-32 h-32 mb-4">
                <svg viewBox="0 0 120 120" className="w-32 h-32 -rotate-90">
                  <circle cx="60" cy="60" r="52" fill="none" stroke="#b3e0dc" strokeWidth="12" />
                  <circle
                    cx="60" cy="60" r="52"
                    fill="none"
                    stroke="#037c6e"
              ...
              <Link href="/BISINDO/quiz" className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold text-sm rounded-xl py-3 transition">
                Mulai Latihan
              </Link>
            </div>
            ...
            <div className="animate-fade-up-delay-2 bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <Link href="/BISINDO/materi" className="mt-5 inline-flex items-center gap-1 text-teal-600 text-sm font-semibold hover:underline">
            ...
            <div className="animate-fade-up-delay-2 bg-white rounded-2xl border border-gray-100 p-6 min-h-55 flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <IconAward size={20} className="text-teal-600" />
              </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1.5">
        ...
        <p className="text-xs font-bold text-teal-600">{percent}%</p>
      </div>
      <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
        <div className="h-full bg-teal-600 rounded-full transition-all" style={{ width: `${percent}%` }} />
      </div>
    </div>
  );
}
      ...
      <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-36">
        <defs>
          <linearGradient id="areaFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#b3e0dc" stopOpacity="0.3" />
            <stop offset="100%" stopColor="#b3e0dc" stopOpacity="0" />
          </linearGradient>
        </defs>
        <path d={areaPath} fill="url(#areaFill)" />
        <path d={linePath} fill="none" stroke="#037c6e" strokeWidth="2.5" />
      </svg>
      <div className="flex justify-between text-xs text-gray-400 mt-2 px-1">
        {days.map((d) => (
          <span key={d} className={d === "Min" ? "text-teal-600 font-semibold" : ""}>
            {d}
          </span>
        ))}
      </div>
