        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-6">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-slate-800 rounded-2xl aspect-video flex items-center justify-center relative overflow-hidden">
              <button className="w-14 h-14 rounded-full bg-blue-600 flex items-center justify-center shadow-lg hover:bg-blue-700 transition">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="h-34 overflow-y-auto pr-1 space-y-2">
                {kosakataList.map((k, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 border border-gray-100 rounded-xl px-4 py-3 hover:border-blue-200 hover:bg-blue-50/30 transition"
                  >
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm font-bold text-blue-600">{progressPersen}%</span>
              </div>
          ...
          <div className="space-y-4">
            ...
            {/* Tombol selesai */}
            <button className="w-full bg-blue-700 hover:bg-blue-800 text-white font-extrabold text-sm rounded-xl py-4 transition">
              Tandai Selesai & Ke Kuis
            </button>

            {/* Link ke kuis */}
            <div className="bg-blue-50 rounded-xl border border-blue-100 px-4 py-3 flex items-start gap-2">
