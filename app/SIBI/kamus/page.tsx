        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10 min-h-screen">
          ...
          <div className="relative mb-5 animate-fade-up-delay-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          {/* CTA Banner */}
          <div className="mt-12 bg-blue-800 rounded-2xl px-8 py-7 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fade-up-delay-3">
            <div>
              <p className="select-none font-extrabold text-white text-lg">Belum menemukan yang dicari?</p>
              <p className="select-none text-blue-100 text-sm mt-0.5">Bantu kami memperkaya kamus dengan mengusulkan kosakata baru.</p>
            </div>
            <button className="select-none shrink-0 px-6 py-3 rounded-xl bg-white text-blue-800 font-bold text-sm hover:bg-blue-50 transition">
              Usulkan Kosakata
            </button>
          </div>
